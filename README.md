...
Серверная веб страница с именем файла "Hello.cshtml" состоит из следующих частей:
  ...
  5. Заголовок тела страницы первого уровня (всего их 6) со значением "Welcome".
  6. Гипер ссылка на статческую веб страницу с именем файла 'index.html" со значением (текстом) "Simple Html Page". Размещена в параграфе № 1.
  7. Гипер ссылка на обоаботчик веб запросов (веб контроллер) с именем "HelloWorld". Размещена в параграфе № 2.
